...
summary_template = """
      ...
      2. a short summary of the person's work 
      """
...
client = genai.Client(api_key="AIzaSyA4gyqwbyB-0yt0KELP5SFZQWxd1YgE7U8")
response = client.models.generate_content(
    model="gemini-2.0-flash", contents=summary_prompt_template, information=information
)
print(response.text)
